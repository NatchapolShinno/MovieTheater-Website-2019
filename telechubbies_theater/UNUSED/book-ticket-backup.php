...
<div class="container" style="padding-left: 5px !important; padding-right: 5px !important;">
    ...
    <div class="booking-details">
      ...
      <div class="submit-form" style="text-align:center;">
          ...
          <div class="btn btn-info" name="submit-seats" id="submit-seats">SUBMIT</div>
       </div>
    </form>
      ...
      success: function() {
        <?php
          if(!empty($_SESSION['seats']))
            {
            echo 'sc.get([';
          foreach($_SESSION['seats'] as $key => $seat)
            {
            echo "'". $seat . "'" . ',';
            }

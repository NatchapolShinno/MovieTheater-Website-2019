...
<nav id="sidebar">
    ...
    <center>
      ...
      <img src="./employee-img/<?php echo $_SESSION['employee-id'] ?>.jpg" class="profile-img"/>
    ...
    <!--user info-->
      ...
      <form method="POST" action="home-manager.php?edit=1">
            <div class="row">
        <div class="col">
    ...
    <div class="row">
        <div class="col">
          <label for="employee-name">Name</label>
          <input type="text" name="employee-name" class="form-control member-info-field" value="<?php echo $employee_name;?>" />
          ...
          <label for="employee_phone">Phone Number</label>
          <input type="text" name="employee_phone" class="form-control member-info-field" value="<?php echo $employee_phone;?>" />
        </div>

        <div class="col">
          <label for="employee_address">Contact Address</label>
          <input type="text" name="employee_address" class="form-control member-info-field" value="<?php echo $employee_address;?>" />

          <label for="employee_dob">Date of Birth</label>
          <input type="text" id="datepicker" name="employee_dob" class="form-control member-info-field" value="<?php echo $employee_dob;?>"/>

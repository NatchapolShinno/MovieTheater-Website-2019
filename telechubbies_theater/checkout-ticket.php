...
<body>
  ...
  <form action="" method="POST">
      ...
      <div class="payment-form">
          ...
          <hr class="mb-4">
          <button name="book-ticket" class="btn btn-primary btn-lg btn-block" type="submit">Confirm</button>
    ...
    <ul class="list-group mb-3">
        ...
        ?>
            <li class="list-group-item d-flex justify-content-between bg-light">
              <div class="text-success">
                ...
                <small><?php echo $_SESSION['discountCode'];?></small>
              </div>
      ...
      <form class="card p-2" method="POST">
        <div class="input-group">
          ...
          if(isset($_SESSION['discountStatus']) AND $_SESSION['discountStatus'] == 0)
            {
            echo "style=\"background: #FF7777;\" placeholder=\"Invalid Code!\"";
            }
          else
            {
            echo "placeholder=\"Promo Code\"";
            }
          ?>
